...
final class SimpleNotificationTypes implements NotificationTypes {
    ...
    private final NotificationType<UnparsedTitle> title = NotificationType.create("title", UnparsedTitle.class, (entity, portal, input) -> {
    ...
    private TagResolver[] placeholders(final Entity entity, final Portal portal) {
    ...
    @Override
    public NotificationType<UnparsedTitle> title() {
        return title;
    }
